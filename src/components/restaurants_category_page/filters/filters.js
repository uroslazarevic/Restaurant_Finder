  ...
  return (
    <div className="filters">
      <div className="filters-title">
        Filters
        <span onClick={searchRestaurants}>
      ...
      <div className="sort-by-category">
        ...
        <ul data-filter="sort" className="sort content">
          <li onClick={changeState} className="item" value="rating">
            Rating <span>- high to low</span>
          </li>
          <li onClick={changeState} className="item" value="cost">
            Cost<span>- high to low</span>
          </li>
        </ul>
      </div>
      ...
      <div className="categories-category">
        ...
        <ul data-filter="category" className="categories-content">
          {categories !== undefined ? (
            categories
              .filter((category) => {
                return category.categories.name !== 'Catching-up' && category.categories.name !== 'Daily Menus'
                  ? category
                  : null;
              })
              .map((category) => {
      ...
      <div className="top-cuisines-category">
        ...
        <ul data-filter="cuisines" className="cuisines content">
          {allCuisines && topCuisines ? (
            allCuisines
              ...
              .map((topCuisine) => {
                ...
                return (
                  <li onClick={changeState} key={id} className="item" value={id}>
                    {name}
                  </li>
                );
              })
          ...
          {cuisineModalItem.cuisineId !== '' ? (
            <li onClick={removeCuisineModalItem} value={cuisineModalItem.cuisineId} className="item active-filter-item">
              {cuisineModalItem.cuisineName}
            </li>
          ) : null}
          <li onClick={handleCuisinesModal} className="item all-cuisines">
            See all cuisines
          </li>
        </ul>
      </div>
      ...
      <div className="order-by-category">
        ...
        <ul data-filter="order" className="order content">
          <li onClick={changeState} className="item" value="asc">
            Ascending order
          </li>
          <li onClick={changeState} className="item" value="desc">
            Descending order
          </li>
        </ul>
      </div>
