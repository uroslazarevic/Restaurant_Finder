...
export default ({ resInfo, resReviews, updateDisplayView, currentDisplayView }) => {
        ...
        <div className="restaurant-overview-display" >
          <div className="restaurant-top-content">
            <div className="main-img">
              ...
              <a href={photos_url} target="_blank" ><img src={thumb ? thumb : thumbImgAvatar} alt='restaurant-img'/><span className="photos-link">All Photos</span></a>
            </div>
            <div className="info">
              ...
              <div className="offers"><span className="locality">{locality} </span><li className="categories"> <span className="grey-dot"></span> Category1, Category2</li></div>
              <div className="do-options">
                ...
                <button className="option-btn">
                  <span ><i className="far fa-flag"></i></span>
                  Been Here
                </button>
  ...
  return (
    <div>Restaurant Details Card</div>
  )
}