    ...
    <div className="container">
      {urlPath && (
        <div className="collections-header">
          ...
          <div className="collections-subtitle">
            Explore Curated lists of top restaurants, cafes in {city.cityName}, based on trends
          </div>
        </div>
      )}
      <div className="collections-list">
        ...
        {urlPath && (
          <Link to={{ pathname: url.toLowerCase(), state: { cityName, cityId } }} className="collection-item-all">
...
function createCollectionItems(collections, city, filterOutId, userCollection) {
  const { cityName, cityId } = city;
  const collectionsArray = filterOutId
        ...
        to={{
          ...
          state: {
            ...
            userCollection: userCollection
              ? { restaurants: collection.collection.restaurants, personalCollection: collection }
              : null,
          },
        }}
      >
